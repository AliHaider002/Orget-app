...
const SaleList = props => {
  ...
  const renderItem = ({item}) => {
    ...
    return (
      <TouchableOpacity
        onPress={() => props.navigation.navigate('SaleEdit', {data: item})}>
        {/* {userid == item?.userid ? ( */}
        <View style={styles.rowContainer1}>
          <View style={styles.column}>
            <Text style={styles.text}>{formattedStartDate}</Text>
  ...
  // const data = [
  //   {id: '1', date: '22-03-29', TO: 'A', qty: 5, Rate: 456},
  //   {id: '1', date: '22-03-29', TO: 'A', qty: 5, Rate: 456},
  //   {id: '1', date: '22-03-29', TO: 'A', qty: 5, Rate: 456},
  //   {id: '1', date: '22-03-29', TO: 'A', qty: 5, Rate: 456},
  // ];
    ...
    <View style={styles.main}>
      ...
      {showfilter === false ? (
        <View
          ...
          <TouchableOpacity
            style={[styles.btn]}
            onPress={() => props.navigation.navigate('SaleNew')}>
